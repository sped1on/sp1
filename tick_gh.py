...
CANDLE_MIN = 15
THRESH_PCT = float(os.environ.get("THRESH_PCT", "0.10"))
HOLD_MIN = int(os.environ.get("HOLD_MIN", "10"))
MAX_DEV_PCT = float(os.environ.get("MAX_DEV_PCT", "0.0"))
MIN_ENTRY_DIST_PCT = float(os.environ.get("MIN_ENTRY_DIST_PCT", "0.15"))
RISK_USD = float(os.environ.get("RISK_USD", "50.0"))
MAX_ENTRY_PRICE = float(os.environ.get("MAX_ENTRY_PRICE", "0.995"))
